...
export const fetchOptions = () => {
    return async (dispatch, getState) => {
        ...
        const userOp = new Options (6, 22795, true, true, true, moment('13:00-03:00', "HH:mmZZ").format("HH:mm"), moment('13:00-03:00', "HH:mmZZ").format("HH:mm"), 
        moment('19:00-03:00', "HH:mmZZ").format("HH:mm"), 'VLz1pJD0g-IacYh3geV8Z2');
